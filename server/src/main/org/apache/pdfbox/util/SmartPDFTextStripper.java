...
public class SmartPDFTextStripper extends PDFStreamEngine
{
    ...
    private static final String thisClassName = SmartPDFTextStripper.class.getSimpleName().toLowerCase();
    ...
    /**
     * Instantiate a new SmartPDFTextStripper object. This object will load
     * properties from SmartPDFTextStripper.properties and will not do
     * anything special to convert the text to a more encoding-specific
     * output.
     *
     * @throws IOException If there is an error loading the properties.
     */
    public SmartPDFTextStripper() throws IOException
    {
    ...
    /**
     * Instantiate a new SmartPDFTextStripper object.  Loading all of the operator mappings
     ...
     */
    public SmartPDFTextStripper( Properties props ) throws IOException
    {
        super( props );
        this.outputEncoding = null;
        normalize = new TextNormalize(this.outputEncoding);
    ...
    /**
     * Instantiate a new SmartPDFTextStripper object. This object will load
     * properties from SmartPDFTextStripper.properties and will apply
     * encoding-specific conversions to the output text.
     *
     * @param encoding The encoding that the output will be written in.
     * @throws IOException If there is an error reading the properties.
     */
    public SmartPDFTextStripper( String encoding ) throws IOException
    {
        super( ResourceLoader.loadProperties(
                "org/apache/pdfbox/resources/PDFTextStripper.properties", true ));
    ...
    /**
     * @deprecated
     * @see SmartPDFTextStripper#getText( PDDocument )
    ...
    /**
     * @deprecated
     * @see SmartPDFTextStripper#writeText( PDDocument, Writer )
